#define dXTAL 16000000UL

#include <stdio.h>
#include <compat/ina90.h>
#include <avr/interrupt.h> // для обработки прерывания
#include <stdbool.h>
#include <avr/iom16.h>
...
//ISR(SIG_OVERFLOW0) //так не компилируется...
ISR(TIMER0_OVF0_vect) //адрес прерывания таймера/счетчика 0 по переполнению
